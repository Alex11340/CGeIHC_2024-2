...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Creamos el techo de la casa, con color azul y una pirámide
		...
		//Creamos las ventanas y la puerta, con color verde y 3 cubos
		shaderList[2].useShader();
		uniformModel = shaderList[2].getModelLocation();
		uniformProjection = shaderList[2].getProjectLocation();

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.25f, 0.f, -4.0f));
		...
		//Creamos los árboles, con color verde oscuro y una pirámide
		...
		//Creamos los troncos de los árboles, con color cafe y un cubo (o 2)
		...
		//Creamos la fachada de la casa, con color rojo y un cubo
