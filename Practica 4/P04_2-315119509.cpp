...
int main()
{
	...
	*/
	camera = Camera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 0.2f, 0.6f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//INICIANDO LA CREACIÓN DE "PERRO" - CUERPO
		model = glm::mat4(1.0);

		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(4.7f, 2.7f, 2.7f));
		...
		//CABEZA
		model = glm::translate(model, glm::vec3(-1.2f, 1.0f, 0.0f));
		modelaux = model;
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.5f, 1.2f, 1.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		sp.render();
		model = modelaux;

		//NARIZ
		model = glm::translate(model, glm::vec3(-1.55f, -0.1f, 0.0f));
		modelaux = model;
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.01f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//OJOS
		model = glm::translate(model, glm::vec3(1.2f, 2.2f, 0.7f));
		modelaux = model;
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.275f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		model = modelaux;
		...
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.275f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		model = modelaux;

		//OREJAS
		model = glm::translate(model, glm::vec3(1.9f, -0.45f, 1.2f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(55.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.03f, 1.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.35f, 0.15f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		model = modelaux;
		...
		//COLA
		model = glm::translate(model, glm::vec3(11.5f, -5.0f, 1.6f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	  ...
	  //otras transformaciones para el objeto
	   ...
	   //PATA 3 - 
		//articulación 1
	   model = glm::translate(model, glm::vec3(-2.5f, 2.0f, -2.5f));
	   //rotación alrededor de la articulación que une con el cuerpo
