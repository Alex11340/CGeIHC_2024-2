...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//SE REINICIA PARA QUE AHORA NUESTRAS ESCALADOS SEAN CORRECTOS
		model = glm::mat4(1.0);
		...
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		//Se rotan 90 grados, debido a que estamos tomando en cuenta que nuestro eje ya esta rotado 135°
		...
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, 0.0f));
		//Se rotan 45 grados (Con esto, en nuestro plano, X pasa a ser Y, y viceversa)
